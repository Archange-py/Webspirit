...
en utilisant le package python, et de visualiser toutes les données téléchargées de manière dynamique.
Il permet entre autre de gérer de manière simple et transparente ses favoris dans des collections.
"""